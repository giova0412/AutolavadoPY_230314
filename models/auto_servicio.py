...
class AutoServicio(Base):
    ...
    auto_id = Column(Integer, ForeignKey("tbb_autos.id"))
    cajero_id = Column(Integer, ForeignKey("tbc_usuarios.id"))
    operador_id = Column(Integer, ForeignKey("tbc_usuarios.id"))
